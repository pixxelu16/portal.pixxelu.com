...
class InqueryController extends Controller
{
    ...
    public function all_inqueries() {
        ...
        return view('admin.inquery.all-inqueries-list', compact('all_inqueries_list'));
    }
    ...
    public function all_converted_inqueries() {
        ...
        $all_inqueries_list = Inquery::orderBy('ID', 'DESC')->where('status', 'Converted')->get();
        return view('admin.inquery.all-converted-inqueries-list', compact('all_inqueries_list'));
    }
    ...
    public function search_inquery_status_list(Request $request) {
        ...
        return view('admin.inquery.search-inqueries-list', compact('all_inqueries_list'));
    }
    ...
    public function search_inquery_course_type_list(Request $request) {
        ...
        return view('admin.inquery.search-inqueries-course-type', compact('all_inqueries_list'));
    }

    //Function for add new inquery
    public function add_inquery() {
        return view('admin.inquery.add-new-inquery');
    }
    ...
    public function edit_inquery($id) {
        ...
        return view('admin.inquery.edit-inquery', compact('inquery'));
    }
    ...
    public function update_inquery(Request $request, $id) {
        ...
        if ($is_update_inquery) {
            ...
            return redirect()->route('admin.students.list', ['id' => $id]);
        } else {
