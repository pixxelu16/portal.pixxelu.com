...
class ProfileController extends Controller
{
    ...
    public function edit_profile() {
        ...
        $employee = User::where('id', $is_login_id)->first();
        return view('employee.profiles.edit-profile-detail', compact('employee'));
    }
    ...
    public function update_profile(Request $request, $id) {
        ...
        if($request->hasFile('image')) {
            ...
            $filename = ProfileImage::store($file, 'uploads/employees');
    ...
    public function changed_password(){
        ...
        return view('employee.profiles.change-password', compact('user_profile'));
    }
