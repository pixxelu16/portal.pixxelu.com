...
{ 
    ...
    public function add_student() {
        return view('super-admin.students.add-new-student');
    }
    ...
    public function edit_student($id) {
        ...
        return view('super-admin.students.edit-student', compact('student'));
    }
    ...
    //         return view('super-admin.students.edit-student-fees', compact('student_fees_detail'));
    // }

    // //Function for update student fees
    // public function update_student_fees(Request $request, $id){
   ...
   //Function for student assign accessories
    ...
    public function search_students_list(Request $request) {
        ...
        return view('super-admin.students.search-students-list', compact('get_students_detail','all_students_total_fees','all_students_paid_fees'));
    }
    ...
    public function search_students_fees_list(Request $request) {
        ...
        return view('super-admin.students.search-students-fees-list', compact('get_students_list', 'all_students_total_fees', 'all_students_paid_fees'));
    }
    ...
    public function all_trash_students_list() {
       ...
       $all_students_total_fees = User::sum('total_fees');
       $all_students_paid_fees = StudentFees::sum('user_fees');  
           return view('super-admin.students.all-students-trash-list', compact('get_students_detail','all_students_total_fees','all_students_paid_fees'));
    }
    ...
    public function add_new_stock() {
        return view('super-admin.stocks.add-new-stock');
    }
