...
<div class="portal-listing">
   <div class="portal-listing-toolbar">
      <div class="portal-listing-toolbar-left">
         ...
         <form action="{{ url('admin/export-inqueries') }}" method="GET" class="portal-inline-form">
      ...
      <div class="portal-listing-toolbar-right">
         <a href="{{ url('admin/all-converted-inqueries-list') }}" class="portal-btn-outline">Converted</a>
         <a href="{{ url('admin/add-new-inquery') }}" class="portal-btn-primary"><i class="bi bi-plus-lg"></i> Add Inquiry</a>
      </div>
   </div>
      ...
      <table id="portalListingTable" class="portal-table portal-table-inquiries">
         ...
         <tbody>
            ...
            <tr>
               ...
               <td>
                  <a class="portal-icon-btn portal-icon-edit" href="{{ url('admin/edit-inquery', $list->id) }}" title="Edit">
