...
<div class="portal-listing">
   <div class="portal-listing-toolbar">
      ...
      <div class="portal-listing-toolbar-right">
         <a href="{{ url('admin/add-new-intern') }}" class="portal-btn-primary"><i class="bi bi-plus-lg"></i> Add Intern</a>
      </div>
   </div>
            ...
            <tr>
               ...
               <td>
                  <div class="portal-row-actions">
                     ...
                     <a href="{{ url('admin/edit-intern', $student->id) }}" class="portal-icon-btn portal-icon-edit" title="Edit">
