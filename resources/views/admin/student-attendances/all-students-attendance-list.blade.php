...
<div class="title-subheading">
   ...
   <div class="portal-attendance-header">
      ...
      <div class="portal-attendance-actions">
         <form action="{{ url('admin/students/attendance/download-pdf') }}" method="GET" class="portal-inline-form">
            <select name="type" class="portal-select portal-select-sm" required onchange="this.form.submit()">
               <option value="" disabled selected>Download PDF</option>
   ...
   <div class="portal-attendance-scroll">
      <table id="example10" class="portal-table portal-attendance-table">
         ...
         <tbody>
            ...
            @empty
            <tr><td colspan="{{ count($days) + 4 }}" class="portal-no-data">No attendance records found.</td></tr>
            @endforelse
         </tbody>
      </table>
   </div>
   ...
   <div class="modal-dialog" role="document">
      <div class="modal-content">
         <div class="modal-header-damage">
            <h4 class="modal-title">Edit Attendance — <span class="student_attendances"></span></h4>
         ...
         <div class="modal-body">
            <form action="#" id="student_attendances" method="POST">
               ...
               <div class="form-group">
                  <label>Batch Timing <span class="text-danger">*</span></label>
               ...
               <div class="modal-footer">
                  <button type="submit" class="btn btn-primary is_create_student_attendance portal-btn-primary">Update</button>
               </div>
            </form>
...
function setCurrentTimeInIST() {
   var t = new Date().toLocaleTimeString('en-US', { timeZone: 'Asia/Kolkata', hour12: false, hour: '2-digit', minute: '2-digit' });
   var pin = document.getElementById('punch_in_time');
   var pout = document.getElementById('punch_out_time');
   if (pin) pin.value = t;
   if (pout) pout.value = t;
}
