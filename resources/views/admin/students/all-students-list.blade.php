...
<div class="portal-listing">
   <div class="portal-listing-toolbar">
      <div class="portal-listing-toolbar-left">
         ...
         <form action="{{ url('admin/export-student') }}" method="GET" class="portal-inline-form">
      ...
      <div class="portal-listing-toolbar-right">
         <a href="{{ url('admin/all-students-trash-list') }}" class="portal-btn-outline"><i class="bi bi-trash3"></i> Trash</a>
         <a href="{{ url('admin/add-new-student') }}" class="portal-btn-primary"><i class="bi bi-plus-lg"></i> Add Student</a>
      </div>
   </div>
            ...
            <tr>
               ...
               <td>
                  <div class="portal-row-actions">
                     <a href="{{ url('admin/download-receipt/' . $student->id) }}" target="_blank" class="portal-icon-btn portal-icon-download" title="Download Receipt">
                        <i class="bi bi-download"></i>
                     </a>
                     <a href="{{ url('admin/edit-student', $student->id) }}" class="portal-icon-btn portal-icon-edit" title="Edit">
   ...
   <div class="modal-dialog">
      <div class="modal-content">
         ...
         <div class="modal-body">
            <form action="{{ url('admin/submit-student-fees') }}" id="is_create_student_fee" method="POST" novalidate>
               @csrf
