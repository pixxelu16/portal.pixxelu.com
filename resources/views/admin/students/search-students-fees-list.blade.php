         ...
         <table id="example1" class="rwd-table cloud-path">
            ...
            <tbody>
               ...
               <tr>
                  ...
                  <!-- <td><a href="{{ url('admin/single-student-detail/' . $student->id) }}">{{ $student->name }}</a></td> -->
                  <td>
                  ...
                  <div class="dropdown">
                        ...
                        <ul class="dropdown-menu pay-fees-submit">
                           <form class="drop-don-list">
                              ...
                              <li><a href="{{ url('admin/edit-student', $student->id) }}"><img src="{{ url('public/admin/images/ico-4.png') }}">Edit</a></li>
