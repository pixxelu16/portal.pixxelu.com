...
<div class="portal-listing portal-attendance-listing">
   <form action="{{ url('employee/search-attendance') }}" method="GET" class="portal-attendance-filters">
   ...
   <div class="portal-attendance-scroll">
      <table class="portal-table portal-attendance-table">
         ...
         <tbody>
            @php $count = 1; @endphp
            @if($get_employee_detail->isNotEmpty() && $get_employee_detail->first()->employees_attendance_detail->count() > 0)
