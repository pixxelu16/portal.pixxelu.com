...
<div class="main-table">
   ...
   <div class="login-form">
      <form action="{{ route('student.update.profile', $user_profile->id) }}" Method="POST" enctype="multipart/form-data">
         @csrf
         ...
         <div class="form-group display-column">
            <div class="form-design first-name">
               ...
               <input type="text" id="first-name" name="first_name" class="email-disabled" value="{{ $user_profile->first_name }}" placeholder="Enter First Name">
            </div>
            <div class="form-design last-name">
               <label for="last-name">Last Name</label>
               <input type="text" id="last-name" name="last_name" class="email-disabled" value="{{ $user_profile->last_name }}" placeholder="Enter Last Name">
            </div>
         ...
         <div class="form-group display-column">
            ...
            <div class="form-design father-name">
               ...
               <input type="text" id="father_name" name="father_name" value="{{ $user_profile->father_name }}" placeholder="Enter Father Name">
            </div>
            <div class="form-design phone-no">
               <label for="father_phone_no">Father Phone Number</label>
               <input type="text" id="father_phone_no" name="father_phone_no" value="{{ $user_profile->father_phone_no }}" placeholder="Enter Father Phone Number">
            </div>
         </div>
         <div class="form-group display-column">
            <div class="form-design aadhaar-no">
               <label for="aadhar_no">Aadhar Number</label>
               <input type="text" id="aadhar_no" name="aadhaar_no" value="{{ $user_profile->aadhaar_no }}" placeholder="Enter Aaadhar Number">
            </div>
            <div class="form-design student-phone-no">
               <label for="student_phone_no">Student Phone Number</label>
               <input type="text" id="student_phone_no" name="student_phone_no" value="{{ $user_profile->student_phone_no }}" placeholder="Enter Student Phone Number">
            </div>
            <div class="form-design batch-timing">
               ...
               <select id="batch_timing" name="batch_timing" class="email-disabled">
                  ...
                  <option value="10:30 to 5:00" @if($user_profile->batch_timing == '10:30 to 5:00') selected @endif>10:30 to 5:00</option>
               </select>
            </div>
         </div>
         ...
         <div class="form-group display-column">
            ...
            <div class="form-design course">
               ...
               <select class="email-disabled" name="course_type" id="Course Type">
                  ...
                  <option value="Web Designing" @if($user_profile->course_type == 'Web Designing') selected @endif>Web Designing</option>
                  <option value="Web Development" @if($user_profile->course_type == 'Web Development') selected @endif>Web Development</option>
                  <option value="Php" @if($user_profile->course_type == 'Php') selected @endif>PHP</option>
                  <option value="Graphic" @if($user_profile->course_type == 'Graphic') selected @endif>Graphic</option>
                  <option value="Full Stack Development" @if($user_profile->course_type == 'Full Stack Development') selected @endif>Full Stack Development</option>
               </select>
            </div>
            <div class="form-design duration">
               ...
               <select class="email-disabled" name="course_duration" id="Course Duration">
                  ...
                  <option value="1 Month" @if($user_profile->course_duration == '1 Month') selected @endif>1 Month</option>
                  <option value="3 Month" @if($user_profile->course_duration == '3 Month') selected @endif>3 Month</option>
                  <option value="6 Month" @if($user_profile->course_duration == '6 Month') selected @endif>6 Month</option>
                  <option value="1 Year" @if($user_profile->course_duration == '1 Year') selected @endif>1 Year</option>
                  <option value="2 Year" @if($user_profile->course_duration == '2 Year') selected @endif>2 Year</option>
               </select>
            </div>
         </div>
         <div class="form-group display-column">
            <div class="form-design join-date">
               ...
               <input type="date" id="course_joining_date" class="email-disabled" name="course_joining_date" value="{{ $user_profile->course_joining_date }}">
            </div>
            <div class="form-design end-date">
               <label for="course_complession_date">Course Complession Date</label>
               <input type="date" id="course_complession_date" name="course_complession_date" class="email-disabled" value="{{ $user_profile->course_complession_date }}">
            </div>
