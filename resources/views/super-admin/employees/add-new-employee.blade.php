...
<div class="main-table">
   <div class="login-form">
      <form action="{{ route('super.admin.submit.employee') }}" Method="POST" enctype="multipart/form-data">
         @csrf 
         ...
         <div class="form-group display-column">
            <div class="form-design password">
               ...
               <input type="password" id="password" name="password" value="{{ old('password') }}" placeholder="Enter Password" required>
            </div>
            ...
            <div class="form-design phone-no">
               ...
               <input type="text" id="phone_no" name="employee_phone_no" value="{{ old('employee_phone_no') }}" placeholder="Enter Phone Number">
            </div>
         </div>
         ...
         <div class="form-group display-column">
            ...
            <div class="form-design resign_date">
               ...
               <input type="date" id="resign_date" name="resign_date" class="email-disabled" value="{{ old('resign_date') }}">
            </div>
         </div>
         <div class="form-group display-column">
            <div class="form-design total_salary">
               <label for="net_salary">Net Salary</label>
               <input type="text" id="total_salary" name="net_salary" value="{{ old('net_salary') }}" placeholder="Enter amount">
            </div>
