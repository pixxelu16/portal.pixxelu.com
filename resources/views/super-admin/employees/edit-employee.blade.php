...
<div class="main-table">
   ...
   <div class="login-form">
      <form action="{{ route('super.admin.update.employee', $employee->id) }}" Method="POST" enctype="multipart/form-data">
         @csrf 
         ...
         <div class="form-group display-column">
            ...
            <div class="form-design employee_role">
               ...
               <select class="form-control" name="employee_role" id="employee_roled">
                  ...
                  <option value="Project Bidder" @if($employee->employee_role == 'Project Bidder') selected @endif>Project Bidder</option>
                  <option value="Php Development" @if($employee->employee_role == 'Php Development') selected @endif>Php Development</option>
                  <option value="Web Development" @if($employee->employee_role == 'Web Development') selected @endif>Web Development</option>
                  <option value="Web Designing" @if($employee->employee_role == 'Web Designing') selected @endif>Web Designing</option>
                  <option value="Graphic Designing" @if($employee->employee_role == 'Graphic Designing') selected @endif>Graphic Designing</option>
                  <option value="SEO" @if($employee->employee_role == 'SEO') selected @endif>SEO</option>
               </select>
            </div>
         ...
         <div class="form-group display-column">
            ...
            <div class="form-design resign_date">
               ...
               <input type="date" id="resign_date" name="resign_date" value="{{$employee->resign_date}}">
            </div>
            <div class="form-design net_salary">
               <label for="net_salary">Total Salary</label>
               <input type="text" id="total_salary" name="net_salary" value="{{ number_format((int) base64_decode($employee->net_salary)) }}" placeholder="Enter amount">
            </div>
         </div>
         <div class="form-group display-column">
            <div class="form-design user_status">
               ...
               <select class="form-control" name="user_status" id="user_status">
                  ...
                  <option value="Active" @if($employee->user_status == 'Active') selected @endif>Active</option>
                  <option value="Pending" @if($employee->user_status == 'Pending') selected @endif>Pending</option>
                  <option value="Suspend" @if($employee->user_status == 'Suspend') selected @endif>Suspend</option>
                  <option value="Completed" @if($employee->user_status == 'Completed') selected @endif>Completed</option>
                  <option value="Leave" @if($employee->user_status == 'Leave') selected @endif>Leave</option>
               </select>
            </div>
         </div>
