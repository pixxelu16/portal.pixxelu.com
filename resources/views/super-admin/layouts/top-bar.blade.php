      ...
      <div class="dropdown-content-panel">
         ...
         <div class="dropdown">
            <div class="user-info dropbtn">
               <img src="{{ url('public/uploads/users/'.auth()->user()->user_pic) }}" alt="{{ auth()->user()->user_pic }}" class="user-pic">
               <p class="user-name">{{ auth()->user()->name }}</p>
            </div>
            <div class="dropdown-content">
               <a href="{{ url('super-admin/profile') }}">Profile</a>
               <a href="{{ url('super-admin/change-password') }}">Change Password</a>
