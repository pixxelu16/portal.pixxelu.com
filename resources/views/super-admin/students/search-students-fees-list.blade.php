...
<div class="main-table">
   <div class="data-table-listing">
      <div class="btn-pixxelu">
         ...
         <a href="{{ route('super.admin.export.paid.fees') }}" class="export"><img src="{{ url('public/admin/images/csv-file.svg') }}">Paid</a>
         <!-- Export Students Monthly Pending Fees list -->
         <a href="{{ route('super.admin.export.pending.fees') }}" class="export"><img src="{{ url('public/admin/images/csv-file.svg') }}">Pending</a>
