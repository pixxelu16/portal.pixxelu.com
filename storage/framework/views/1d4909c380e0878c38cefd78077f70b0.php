      ...
      <div class="dropdown-content-panel">
         ...
         <div class="dropdown">
            ...
            <div class="dropdown-content">
               <a href="<?php echo e(url('student/profile')); ?>">Profile</a>
               <a href="<?php echo e(url('student/change-password')); ?>">Change Password</a>
...
</div><?php /**PATH /home/pixxeluclients/public_html/php-dev/pixxelu-student-portal/resources/views/student/layouts/top-bar.blade.php ENDPATH**/ ?>