...
<div class="main-table">
   ...
   <div class="login-form">
      <form action="<?php echo e(route('super.admin.update.employee', $employee->id)); ?>" Method="POST" enctype="multipart/form-data">
         <?php echo csrf_field(); ?> 
         ...
         <div class="form-group display-column">
            ...
            <div class="form-design employee_role">
               ...
               <select class="form-control" name="employee_role" id="employee_roled">
                  <option value ="" disabled selected>Select Employee Role</option>
                  <option value="Project Bidder" <?php if($employee->employee_role == 'Project Bidder'): ?> selected <?php endif; ?>>Project Bidder</option>
                  <option value="Php Development" <?php if($employee->employee_role == 'Php Development'): ?> selected <?php endif; ?>>Php Development</option>
                  <option value="Web Development" <?php if($employee->employee_role == 'Web Development'): ?> selected <?php endif; ?>>Web Development</option>
                  <option value="Web Designing" <?php if($employee->employee_role == 'Web Designing'): ?> selected <?php endif; ?>>Web Designing</option>
                  <option value="Graphic Designing" <?php if($employee->employee_role == 'Graphic Designing'): ?> selected <?php endif; ?>>Graphic Designing</option>
                  <option value="SEO" <?php if($employee->employee_role == 'SEO'): ?> selected <?php endif; ?>>SEO</option>
               </select>
            </div>
         ...
         <div class="form-group display-column">
            ...
            <div class="form-design resign_date">
               ...
               <input type="date" id="resign_date" name="resign_date" value="<?php echo e($employee->resign_date); ?>">
            </div>
            <div class="form-design net_salary">
               <label for="net_salary">Total Salary</label>
               <input type="text" id="total_salary" name="net_salary" value="<?php echo e(number_format((int) base64_decode($employee->net_salary))); ?>" placeholder="Enter amount">
            </div>
         </div>
         <div class="form-group display-column">
            <div class="form-design user_status">
               ...
               <select class="form-control" name="user_status" id="user_status">
                  ...
                  <option value="Active" <?php if($employee->user_status == 'Active'): ?> selected <?php endif; ?>>Active</option>
                  <option value="Pending" <?php if($employee->user_status == 'Pending'): ?> selected <?php endif; ?>>Pending</option>
                  <option value="Suspend" <?php if($employee->user_status == 'Suspend'): ?> selected <?php endif; ?>>Suspend</option>
                  <option value="Completed" <?php if($employee->user_status == 'Completed'): ?> selected <?php endif; ?>>Completed</option>
                  <option value="Leave" <?php if($employee->user_status == 'Leave'): ?> selected <?php endif; ?>>Leave</option>
               </select>
            </div>
         </div>
...
<?php echo $__env->make('super-admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\pixxelu-student-portal-new\resources\views/super-admin/employees/edit-employee.blade.php ENDPATH**/ ?>