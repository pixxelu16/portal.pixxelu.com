         ...
         <div class="form-group display-column">
            ...
            <div class="form-design batch-timing">
               ...
               <select id="batch_timing" name="batch_timing" class="form-control">
                  ...
                  <option value="10:30 to 5:00" <?php if($student->batch_timing == '10:30 to 5:00'): ?> selected <?php endif; ?>>10:30 to 5:00</option>
               </select>
            </div>
         </div>
         <div class="form-group display-column">
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/pixxeluclients/public_html/php-dev/pixxelu-student-portal/resources/views/admin/students/edit-student.blade.php ENDPATH**/ ?>