<nav>
   ...
   <div class="menu-items">
      <ul class="nav-links">
         ...
         <!--   </a>-->
         <!--</li>-->
         <li class="attendance_overview nav-item dropdown <?php echo e(request()->is('admin/all-employees-attendance-list') || request()->is('admin/all-students-attendance-list') ? 'active' : ''); ?>">
  ...
  <ul class="dropdown-menu" aria-labelledby="attendanceDropdown">
    <li class="<?php echo e(request()->is('admin/all-employees-attendance-list') ? 'active' : ''); ?>">
      <a href="<?php echo e(url('admin/all-employees-attendance-list')); ?>" class="dropdown-item">
        Staff Attendance
      </a>
    </li>
    <li class="<?php echo e(request()->is('admin/all-students-attendance-list') ? 'active' : ''); ?>">
      <a href="<?php echo e(url('admin/all-students-attendance-list')); ?>" class="dropdown-item">
        Student Attendance
      </a>
    </li>
  </ul>
...
<?php /**PATH /home/pixxeluclients/public_html/php-dev/pixxelu-student-portal/resources/views/admin/layouts/sidebar.blade.php ENDPATH**/ ?>