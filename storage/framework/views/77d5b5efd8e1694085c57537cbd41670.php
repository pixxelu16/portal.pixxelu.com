...
<div class="main-table">
   <div class="data-table-listing">
      <div class="btn-pixxelu">
         ...
         <a href="<?php echo e(route('super.admin.export.paid.fees')); ?>" class="export"><img src="<?php echo e(url('public/admin/images/csv-file.svg')); ?>">Paid</a>
         <!-- Export Students Monthly Pending Fees list -->
         <a href="<?php echo e(route('super.admin.export.pending.fees')); ?>" class="export"><img src="<?php echo e(url('public/admin/images/csv-file.svg')); ?>">Pending</a>
                     ...
                     <div class="dropdown">
                        ...
                        <ul class="dropdown-menu pay-fees-submit">
                           <form class="drop-don-list">
                              ...
                              <li><a href="<?php echo e(url('super-admin/edit-student', $student->id)); ?>"><img
...
<?php echo $__env->make('super-admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\pixxelu-student-portal-new\resources\views/super-admin/students/search-students-fees-list.blade.php ENDPATH**/ ?>