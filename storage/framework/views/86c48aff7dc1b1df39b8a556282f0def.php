<nav>
   <div class="logo-name">
      <div class="logo-image">
         ...
         <img src="<?php echo e(url('public/admin/images/Menu.svg')); ?>" alt="">
         </i>
      </div>
   </div>
   <div class="menu-items">
      <?php if(Auth::user()->access_type == 'Inquery'): ?>
      <ul class="nav-links">
         ...
         <li class="nav-item">
            ...
            <img src="<?php echo e(url('public/admin/images/logout.svg')); ?>" alt="logout" />
      ...
      <ul class="logout-mode">
         <li><a href="#">
            <img src="<?php echo e(url('public/admin/images/help.svg')); ?>" alt="help" />
            <span class="link-name">Help</span>
            </a>
         </li>
         <li class="<?php echo e(request()->is('admin/setting') ? 'active' : ''); ?>">
            <a href="<?php echo e(url('admin/setting')); ?>">
            <img src="<?php echo e(url('public/admin/images/setting.svg')); ?>" alt="settings" />
