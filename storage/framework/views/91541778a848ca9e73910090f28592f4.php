...
<div class="main-table">
   ...
   <div class="student-change-password">
      <form action="<?php echo e(route('student.changed.password', $user_profile->id)); ?>" method="POST" enctype="multipart/form-data">
         <?php echo csrf_field(); ?>
...
<?php echo $__env->make('student.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/pixxeluclients/public_html/php-dev/pixxelu-student-portal/resources/views/student/profiles/change-password.blade.php ENDPATH**/ ?>