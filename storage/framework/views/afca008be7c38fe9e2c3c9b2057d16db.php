               ...
               <tr>
                  ...
                  <td data-th="Image">
                     <div class="user-image">
                        <?php if($student->student_fees_detail->user_pic): ?>
                        <img src="<?php echo e(url('public/uploads/users/' . $student->student_fees_detail->user_pic)); ?>" alt="User Image">
                        <?php else: ?>
                  ...
                  <td>
                     <span onclick="openNav()"><a href="#" class="student-link" data-student_id="<?php echo e($student->student_fees_detail->id); ?>"><?php echo e($student->student_fees_detail->name); ?></a></span>
                  </td>
                  <td>
                     <?php if($student->student_fees_detail->student_phone_no): ?>
                     <a href="https://wa.me/<?php echo e(str_replace(['+', '-', ' '], '', $student->student_fees_detail->student_phone_no)); ?>" target="_blank">
                     <?php echo e(substr($student->student_fees_detail->student_phone_no, 0, 5)); ?>-<?php echo e(substr($student->student_fees_detail->student_phone_no, 5)); ?>
                  ...
                  <td><?php echo e(\Carbon\Carbon::parse($student->student_fees_detail->course_joining_date)->format('d M Y')); ?></td>
                  <?php if($student->student_fees_detail->course_type == 'Full Stack Development'): ?> 
                  <td class="lights-blue-color"><span>Full Stack Development</span></td>
                  <?php elseif($student->student_fees_detail->course_type == 'PHP Development'): ?>
                  <td class="lights-green-color"><span>PHP Development</span></td>
                  <?php elseif($student->student_fees_detail->course_type == 'Web Development'): ?>
                  <td class="light-yellow-color"><span>Web Development</span></td>
                  <?php elseif($student->student_fees_detail->course_type == 'Web Designing'): ?>
                  <td class="light-pink-color"><span>Web Designing</span></td>
                  <?php elseif($student->student_fees_detail->course_type == 'Graphic Designing'): ?>
                  <td class="light-cyan-color"><span>Graphic Designing</span></td>
                  <?php else: ?>
                  <td></td>
                  <?php endif; ?>
                  <td><?php echo e($student->user_fees); ?><br>
                     <span class="date-tbl"><?php echo e(Carbon::parse($student->submission_date)->format('d M Y')); ?></span>
                  </td>
                  <?php if($student->payment_type =='cash'): ?> 
                  <td>Cash</td>
                  <?php else: ?>
                  <td>Online</td>
                  <?php endif; ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/pixxeluclients/public_html/php-dev/pixxelu-student-portal/resources/views/admin/dashboard.blade.php ENDPATH**/ ?>