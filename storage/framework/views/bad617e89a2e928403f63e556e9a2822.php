      ...
      <table id="example1" class="rwd-table cloud-path">
            ...
            <tbody>
               ...
               <tr>
                  ...
                  <?php endif; ?>
                  <td>
                     <?php if(isset($student->student_fees_detail) && $student->student_fees_detail->isNotEmpty()): ?>
                        <?php
                        ...
                        ?>
                        <?php if($totalFees > 0): ?>
                              Rs <?php echo e(number_format($totalFees)); ?><br>
                              <span class="date-tbl"><?php echo e(Carbon::parse($payment->submission_date)->format('d M Y')); ?></span>
                        <?php else: ?>
                              -<br>  
                        <?php endif; ?>
                     <?php else: ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pixxelu-student-portal-new\resources\views/admin/students/search-students-fees-list.blade.php ENDPATH**/ ?>