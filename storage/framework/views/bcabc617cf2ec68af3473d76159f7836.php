...
<div class="main-table">
   ...
   <div class="login-form">
      <form action="<?php echo e(route('super.admin.update.profile', $user_profile->id)); ?>" Method="POST" enctype="multipart/form-data">
         <?php echo csrf_field(); ?>
         ...
         <div class="form-group display-column">
            <div class="form-design first-name">
               ...
               <input type="text" id="first-name" name="first_name" value="<?php echo e($user_profile->first_name); ?>" placeholder="Enter First Name">
            </div>
            <div class="form-design last-name">
               <label for="last-name">Last Name</label>
               <input type="text" id="last-name" name="last_name" value="<?php echo e($user_profile->last_name); ?>" placeholder="Enter Last Name">
            </div>
         ...
         <div class="form-group display-column">
            ...
            <div class="form-design phone-no">
               ...
               <input type="text" id="father_phone_no" name="employee_phone_no" value="<?php echo e($user_profile->employee_phone_no); ?>" placeholder="Enter Phone Number">
            </div>
            <div class="form-design aadhaar-no">
               <label for="aadhar_no">Aadhar Number</label>
               <input type="text" id="aadhaar_no" name="aadhaar_no" value="<?php echo e($user_profile->aadhaar_no); ?>" placeholder="Enter Aaadhar Number">
            </div>
         </div>
         ...
         <div class="form-group display-column">
            ...
            <div class="form-design join-date">
               ...
               <input type="date" id="joining_date" name="joining_date" value="<?php echo e($user_profile->joining_date); ?>">
            </div>
            <div class="form-design district">
...
<?php echo $__env->make('super-admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\pixxelu-student-portal-new\resources\views/super-admin/profiles/edit-profile-detail.blade.php ENDPATH**/ ?>