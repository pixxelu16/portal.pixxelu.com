...
<div class="main-table">
   ...
   <div class="student-change-password">
      <form action="<?php echo e(route('employee.changed.password', $user_profile->id)); ?>" method="POST" enctype="multipart/form-data">
         <?php echo csrf_field(); ?>
...
<?php echo $__env->make('employee.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pixxelu-student-portal-new\resources\views/employee/profiles/change-password.blade.php ENDPATH**/ ?>