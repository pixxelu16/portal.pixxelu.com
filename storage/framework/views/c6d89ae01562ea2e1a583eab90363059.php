            ...
            <td align="center">
               <div class="email-container">
                  ...
                  <div class="email-content">
                     ...
                     <tr>
                           <th>Name</th>
                           <td><?php echo e($contact_data->name); ?></td>
                        </tr>
                        <tr>
                           <th>Email</th>
                           <td><?php echo e($contact_data->email); ?></td>
                        </tr>
                        <tr>
                           <th>Mobile</th>
                           <td><?php echo e($contact_data->mobile); ?></td>
                        </tr>
                        <tr>
                           <th>Company</th>
                           <td><?php echo e($contact_data->company); ?></td>
                        </tr>
                        <tr>
                           <th>Message</th>
                           <td><?php echo e($contact_data->message); ?></td>
                        </tr>
                     </table>
                  </div>
                  <!-- Footer Section -->
...
</html><?php /**PATH C:\xampp\htdocs\pixxelu-student-portal-new\resources\views/admin/contacts/contact-us.blade.php ENDPATH**/ ?>