         ...
         <table class="table table-striped custom-table table-nowrap mb-0">
            ...
            <?php if($get_student_detail->first()->student_attendance_detail->count() > 0): ?>
               <tbody>
                  ...
                  <tr>
                     <td colspan="<?php echo e(count($days) + 6); ?>" class="text-center">No Attendances found</td>
                  </tr>
                  <?php endif; ?>
               </tbody>
            <?php else: ?>
...
<?php echo $__env->make('student.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pixxelu-student-portal-new\resources\views/student/attendances/search-student-attendances.blade.php ENDPATH**/ ?>