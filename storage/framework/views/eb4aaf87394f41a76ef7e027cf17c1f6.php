...
<div class="main-table">
   <div class="data-table-listing">
      <div class="btn-pixxelu">
         ...
         <a href="<?php echo e(url('admin/add-new-student')); ?>"><img src="<?php echo e(url('public/admin/images/pluse.svg')); ?>">Add New
         Student</a>
         <a href="<?php echo e(url('admin/export-student')); ?>" class="export"><img
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/pixxeluclients/public_html/php-dev/pixxelu-student-portal/resources/views/admin/students/all-students-list.blade.php ENDPATH**/ ?>