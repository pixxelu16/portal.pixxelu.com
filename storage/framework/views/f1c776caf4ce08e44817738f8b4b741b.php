...
<div class="main-table">
   <div class="data-table-listing">
      <div class="btn-pixxelu">
         ...
         <!-- <a href="<?php echo e(url('super-admin/export-inqueries')); ?>" class="export"><img src="<?php echo e(url('public/admin/images/csv-file.svg')); ?>"></a> -->
         <a href="<?php echo e(url('super-admin/all-converted-inqueries-list')); ?>">Converted Inqueries</a>
      ...
      <form action="<?php echo e(url('super-admin/export-inqueries')); ?>" method="GET">
               ...
               <?php $__currentLoopData = $all_inqueries_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>   
                  <tr>
                     ...
                     <?php if($list->course_type == 'Full Stack Development'): ?> 
                        ...
                        <?php elseif($list->course_type == 'Graphic'): ?>
                     ...
                     <td><?php echo e(\Carbon\Carbon::parse($list->created_at)->format('d M Y')); ?></td>
                        ...
                        <!--<a class="btn btn-danger btn-sm" href="<?php echo e(url('admin/delete-inquery', $list->id)); ?>"><i class="fas fa-trash-alt"></i> Delete</a> -->
                     </td>
                  </tr>
...
<?php echo $__env->make('super-admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\pixxelu-student-portal-new\resources\views/super-admin/inquery/all-inqueries-list.blade.php ENDPATH**/ ?>