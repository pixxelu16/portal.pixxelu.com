      ...
      <div class="col-sm-6 col-md-3">
         ...
         <select class="select floating" name="month">
            ...
            <?php $__currentLoopData = $months; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
               <option value="<?php echo e($key); ?>" <?php echo e(\Carbon\Carbon::now()->format('m') === $key ? 'selected' : ''); ?>>
                     <?php echo e($name); ?>
...
<div class="row">
   <div class="col-lg-12">
    ...
    <?php
        $count = 1;
    ?>
    <?php $__empty_1 = true; $__currentLoopData = $get_all_employees_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
    <tr>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/pixxeluclients/public_html/php-dev/pixxelu-student-portal/resources/views/admin/employees/all-employees-attendance-list.blade.php ENDPATH**/ ?>